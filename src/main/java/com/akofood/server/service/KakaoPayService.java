...
public class KakaoPayService {
    ...
    public ReadyResponse payReady(String name, int totalPrice) {
        ...
        parameters.put("approval_url", allowedOriginDeploy + "/order/pay/completed"); // 결제 성공 시 URL
        parameters.put("cancel_url", allowedOriginDeploy + "/order/pay/cancel");      // 결제 취소 시 URL
        parameters.put("fail_url", allowedOriginDeploy + "/order/pay/fail");          // 결제 실패 시 URL
