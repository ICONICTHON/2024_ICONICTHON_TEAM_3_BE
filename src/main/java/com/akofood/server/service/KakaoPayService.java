...
public class KakaoPayService {
    ...
    public ReadyResponse payReady(String name, int totalPrice) {
        ...
        parameters.put("approval_url", "http://localhost/api/order/pay/completed"); // 결제 성공 시 URL
        parameters.put("cancel_url", "http://localhost/api/order/pay/cancel");      // 결제 취소 시 URL
        parameters.put("fail_url", "http://localhost/api/order/pay/fail");          // 결제 실패 시 URL
