...
public class KakaoPayService {
    @Value("${pay.pay-path-origin}")
    private String payPathOrigin;
    ...
    public ReadyResponse payReady(String name, int totalPrice) {
        ...
        parameters.put("approval_url", payPathOrigin+"/order/pay/completed"); // 결제 성공 시 URL
        parameters.put("cancel_url", payPathOrigin+"/order/pay/cancel");      // 결제 취소 시 URL
        parameters.put("fail_url", payPathOrigin+"/order/pay/fail");          // 결제 실패 시 URL
    ...
    private HttpHeaders getHeaders() {
        String kakaoApiSecret = System.getenv("KAKAO_API_SECRET");
        HttpHeaders headers = new HttpHeaders();
        headers.set("Authorization", "SECRET_KEY "+kakaoApiSecret);
